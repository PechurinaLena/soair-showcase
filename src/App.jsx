      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.div
              variants={fromRight}
              style={{ transform: "translateY(-30px)", overflow: "visible" }}
            >
              <HeroPhone
...
function AllScreens() {
  ...
  return (
    <section
      id="screens"
      className="bg-[#faf8f5] py-24 overflow-hidden"
    ...
    >
      ...
      <div
        ...
        style={{
          paddingLeft: "max(48px, calc(50vw - 104px))",
          paddingRight: "max(48px, calc(50vw - 104px))",
          paddingBottom: 24,
          marginTop: "50px",
          height: "550px",
          display: "flex",
        ...
        {ALL_SCREENS.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: 6,
              background:
                i === activeIdx ? "#f97316" : "rgba(148,163,184,0.35)",
              margin: "30px 0 0 0",
              color: "#0f171a",
              margin: "30px 7px",
